...
class AddFeat(MainMenu):
    def __init__(self, master, hero):
        ...
        self.bt_submit = tk.Button(  # for finalizing your inputs.
            ...
            height=0,
            command=lambda:[
                self.hero.add_feat(self.e_name.get(), self.e_desc.get()),
                self.master.destroy()
            ]
        )
